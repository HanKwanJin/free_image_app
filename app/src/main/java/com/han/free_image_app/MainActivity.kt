package com.han.free_image_app
...
import com.han.free_image_app.data.Repository
import com.han.free_image_app.data.models.PhotoResponse
import com.han.free_image_app.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun bindView() {
        binding.searchEditText
            .setOnEditorActionListener { editText, action, event ->
    ...
    private fun requestsStoragePermission(){
